...
$targetVMs = @("ContosoDC","ContosoSQL2","ContosoSCOM")
#$targetVMs = @("ContosoSQL2","ContosoOrch","ContosoWAP1","ContosoWSFCNode","ContosoDC")
...
#Scenario 3: Service Management VMs for SCOM
<#
#$targetVMs = @(("ContosoDC","ContosoDC1982"),("ContosoCMCAS","ContosoSCCM"),("ContosoCMPRI","ContosoSCCM"),("ContosoCMPRI2","ContosoCMPRI2"),("win7test","kevinyetest"),("win10test","win10test-78tim30o"))
$targetVMs = @("ContosoDC","ContosoSQL2","ContosoSCOM")
#$targetVMs = @("ContosoSQL2","ContosoSCOM")
$azureAcct = "chunye@live.com"
$serviceMode = "SM"
#$opsMode = "Start"
#$opsMode = "Stop"
